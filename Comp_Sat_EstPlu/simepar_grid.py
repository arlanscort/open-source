...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  3 11:51:01 2023
...
times = xr.open_dataset('data/dados-processados/gsmap-nrt/201803.nc').time.to_dataframe().reset_index(drop=True)
f = 'data/dados-processados/gsmap-nrt/201803.nc'
...
def read_nc (path):
    ...
    for i in range(len(times)):
        ...
        for f in nc_files:
            ...
            df_time = xr_nc.loc[xr_nc['time'] == times.time[i]]  
